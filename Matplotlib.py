...
axes = fig.add_axes([0.3, 0.3, 0.8, 0.8]) # left, bottom, width, height (range 0 to 1)
...
ax.plot(x, x+15, color="purple", lw=1, ls='-', marker='o', markersize=8, markerfacecolor="blue")
...
matplotlib.rcParams['xtick.major.pad'] = 50
...
fig.subplots_adjust(left=0.5, right=.8, bottom=0.2, top=0.7);
...
axes[1].grid(color='b', alpha=0.2, linestyle='dashed', linewidth=2.0)
...
#controls the transparency or opacity of graphical elements, such as points, lines, and shapes.
...
#Specifies the extent of the image along the x and y axes. In this case, the image spans the unit square from (0, 0) to (1, 1).
#interpolation method used for rendering the image, helps to create a smoother and 
...
#Disables antialiasing, which can make the edges of the surface appear smoother. 
#Setting it to False may result in a faster rendering.
